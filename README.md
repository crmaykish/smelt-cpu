...
This CPU design is simulation-focused, but the core is also fully synthesizable on a real FPGA.

See [the ISA spec](ISA.md) for the detailed description of registers and opcodes.
